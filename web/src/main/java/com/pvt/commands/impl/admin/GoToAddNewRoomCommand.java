...
public class GoToAddNewRoomCommand implements Command {
    ...
    public String execute(HttpServletRequest request) {
        ...
        if (UserRole.ADMIN.equals(user.getUserRole())) {
            ...
            request.setAttribute(Parameters.NEW_ROOM_NUMBER_FORMAT_REGEXP, ValidationManager.getInstance().getProperty(ValidationConstants.NEW_ROOM_NUMBER_FORMAT_REGEXP));
            request.setAttribute(Parameters.NEW_ROOM_NUMBER_FORMAT_PLACEHOLDER, ValidationManager.getInstance().getProperty(ValidationConstants.NEW_ROOM_NUMBER_FORMAT_PLACEHOLDER));
            ...
            try {
                request.setAttribute(Parameters.NEW_ROOM_MIN_ROOMINESS, Integer.valueOf(ValidationManager.getInstance().getProperty(ValidationConstants.NEW_ROOM_MIN_ROOMINESS)));
                request.setAttribute(Parameters.NEW_ROOM_ROOMINESS_STEP, Integer.valueOf(ValidationManager.getInstance().getProperty(ValidationConstants.NEW_ROOM_ROOMINESS_STEP)));
                request.setAttribute(Parameters.NEW_ROOM_MIN_PRICE, Integer.valueOf(ValidationManager.getInstance().getProperty(ValidationConstants.NEW_ROOM_MIN_PRICE)));
                request.setAttribute(Parameters.NEW_ROOM_PRICE_STEP, Integer.valueOf(ValidationManager.getInstance().getProperty(ValidationConstants.NEW_ROOM_PRICE_STEP)));
